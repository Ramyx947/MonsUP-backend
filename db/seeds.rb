...
# Users
users = [
  {username: "Emily", email: "emily@yahoo.com"},
  {username: "Ramona", email: "ramona@yahoo.com"},
  {username: "Greg", email: "greg@yahoo.com"}
]
...
trips = [
  ...
  {title: "Everest Base Camp",
    ...
    category: "hiking",
    user: User.find_by(username: "Ramona")},
  {title: "Kili adventure", start_date: "07/01/2019", end_date: "13/01/2019", number_days: 7, country: "Tanzanian", city: "MOSHI", category: "hiking", user: User.find_by(username: "Ramona")},
  {title: "New Zealand holiday", start_date: "14/01/2019", end_date: "20/01/2019", number_days: 7 , country: "New Zealand", city: "Queenstown", category: "hiking", user: User.find_by(username: "Greg")},
  {title: "Ben Nevis and Glencoe trip ", start_date: "20/10/2018", end_date: "25/10/2018", number_days: 6 , country: "UK", city: "Glasgow", category: "hiking", user: User.find_by(username: "Emily")},
  {title: "Carpathian Mountains Trip", start_date: "10/07/2018", end_date: "11/07/2018", number_days: 2, country: "Romania", city: "Brasov", category: "hiking", user: User.find_by(username: "Ramona")}
]
trips.each{|trip_data| Trip.create(trip_data)}

#Physical Rating
physical_ratings = [
  {difficulty: "demanding", trip:Trip.find_by(title: "Inca Trail - my long awaited holiday" )},
  {difficulty: "challenging", trip:Trip.find_by(title: "Everest Base Camp" )},
  {difficulty: "demanding", trip:Trip.find_by(title: "Kili adventure" )},
  {difficulty: "average", trip:Trip.find_by(title: "New Zealand holiday" )},
  {difficulty: "average", trip:Trip.find_by(title: "Ben Nevis and Glencoe trip ")},
  {difficulty: "average", trip:Trip.find_by(title: "Carpathian Mountains Trip")}
]
...
days = [
  # Peru 5
  { title: "Day 1: Arrive in Lima ", start_point: "London", end_point: "Lima", distance: "",
    ...
    trip: Trip.find_by(title: "Inca Trail - my long awaited holiday" )},
  { title: "Day 2: Cusco ", start_point: "Lima", end_point: "Cusco", distance: "",
    notes: "",
    trip: Trip.find_by(title: "Inca Trail - my long awaited holiday" )},
  { title: "Day 3: Sacred Valey ", start_point: "Cusco", end_point: "Ollantaytambo", distance: "",
    notes: "",
    trip: Trip.find_by(title: "Inca Trail - my long awaited holiday" )},
  { title: "Day 4: Trek over Winay Wayna ", start_point: "Ollantaytambo", end_point: "Inti Punku", distance: "",
    notes: "",
    trip: Trip.find_by(title: "Inca Trail - my long awaited holiday" )},
  { title: "Day 5: Trek to Machu Picchu ", start_point: "Inti Punku ", end_point: "Aguas Calientes", distance: "",
    notes: "",
    trip: Trip.find_by(title: "Inca Trail - my long awaited holiday" )},
# EBC 3
  { title: "Day 1: Kathmandu",
      ...
      notes: "Catch flight from London. Met the rest of the group at the airport and transferred to the hotel. Wander around Miraflores, the area of Lima where the hotel is located.",
      trip: Trip.find_by(title: "Everest Base Camp" )},
...
# Killi 3
  { title: "Day 1: Arrive in MOSHI ", start_point: "MOSHI", end_point: "", distance: 0,
    notes: "",
    trip: Trip.find_by(title: "Kili adventure" )},
...
# NZ 3
  { title: "Day 1: Arrive in Queenstown ", start_point: "London", end_point: "Queenstown", distance: 0,
    notes: "",
    trip: Trip.find_by(title: "New Zealand holiday" )},
...
# Ben Nevis 3
  { title: "Day 1: London - Glasgow-Oban ", start_point: "London", end_point: "Oban", distance: 0,
    notes: "",
    trip: Trip.find_by(title: "Ben Nevis and Glencoe trip ")},
...
# Brasov 1
  { title: "Day 1:Around Brasov ", start_point: "London", end_point: "Brasov", distance: 0,
    ...
    trip: Trip.find_by(title: "Carpathian Mountains Trip" )},
]
...
accommodations.each{|acc_data| Accommodation.create(acc_data)}
